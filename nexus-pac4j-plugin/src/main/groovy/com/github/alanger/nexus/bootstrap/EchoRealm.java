...
/**
 * @deprecated Since 3.61.0 implementation has been moved to com.github.alanger.nexus.plugin.NexusPac4jRealm
 */
@Deprecated
public class EchoRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        try {
            ...
            if (subject != null && subject.isAuthenticated() && subject.getPrincipal().toString().equals(t.getUsername())
