...
/**
 * Transparent authorization filter. Skips a request if it does not meet the specified criteria.
 * 
 * @see org.sonatype.nexus.security.authc.NexusAuthenticationFilter
 * @see org.sonatype.nexus.security.authc.apikey.ApiKeyAuthenticationFilter
 */
